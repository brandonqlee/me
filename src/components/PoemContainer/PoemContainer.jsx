...
import About from '../../poems/About/About';
            ...
            return (
                <Fade>
                    ...
                    <div className="poem-divider" id={this.state.black ? "poem-transition-white-black" : "poem-transition-black-white"}>
                        {this.state.black ? "" : <button onClick={this.goToAbout} style={{color: "white", borderColor: "white", fontWeight: "500"}}>Artist's Statement</button>}
                    </div>
